...
class MainGUI:
    ...
    def set_window_icon(self):
        ...
        try:
            ...
            # Look for icon in different possible locations
            possible_paths = [
                os.path.join(base_path, 'icon.png'),                    # In root folder
                os.path.join(base_path, 'assets', 'icon.png'),          # In assets folder
                os.path.join(base_path, 'src', 'icon.png'),             # In src folder
                r'C:\Users\user\Downloads\icon.png'                     # Your specific path (fallback)
            ]
            ...
            # Silently fail - program works without icon
            pass
    ...
    def show_info_window(self, event=None):
        ...
        # Set icon for info window
        try:
            if hasattr(self.root, 'icon_image'):
                info_window.iconphoto(True, self.root.icon_image)
        except:
            pass
    ...
    def open_setup_window(self, event=None):
        ...
        # Set icon for setup window
        try:
            if hasattr(self.root, 'icon_image'):
                self.setup_window.iconphoto(True, self.root.icon_image)
        except:
            pass
